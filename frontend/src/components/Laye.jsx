...
function Laye() {
    return (
        <div className="flex m-auto gap-[80px] justify-center mt-[100px] pt-[100px] bg-[white]">
            ...
            <div className="max-w-[589px] text-[#474747] flex flex-col gap-[20px]">
                <h2 className="text-[16px] leading-[22px] font-bold text-[#C92071]">Oferta especial</h2>
                ...
                <button className="mt-[15px] text-[#ffffff] max-w-[220px] bg-[#C92071] py-[10px] px-[60px] rounded-xl font-[700]">Ver Oferta</button>
            </div>
        </div>
    );
}
